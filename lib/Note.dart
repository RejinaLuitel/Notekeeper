          ...
          return Padding(
            ...
            child: new Dismissible(
              ...
              onDismissed: (direction) {
                setState(() {
                  deletedNotesHeading = noteHeading[index];
                  deleteNotesDescription = noteDescription[index];
                          ...
                          deletedNotesHeading != ""
                              ? GestureDetector(
                                  onTap: () {
                                    print("undo");
                                    setState(() {
                                      if (deletedNotesHeading != "") {
                                        noteHeading.add(deletedNotesHeading);
                                        noteDescription
                                            .add(deleteNotesDescription);
                                      }
                                      deletedNotesHeading = "";
